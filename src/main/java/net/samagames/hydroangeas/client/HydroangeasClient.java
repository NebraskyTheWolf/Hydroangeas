...
public class HydroangeasClient extends Hydroangeas
{
    ...
    public void loadConfig()
    {
        ...
        try {
            ...
            f.createNewFile();
            InputStreamReader reader = new InputStreamReader(Files.newInputStream(f.toPath()), StandardCharsets.UTF_8);
    ...
    {
        NetworkInterface i = NetworkInterface.getByName("enp27s0");
