...
public class HubBalancer
{
    ...
    public HubBalancer(HydroangeasServer instance)
    {
        ...
        //instance.getScheduler().schedule(this::loadStartedHubs, 18, TimeUnit.SECONDS);
    ...
    public void updateHubTemplate()
    {
        try
        {
            hubTemplate = (SimpleGameTemplate) instance.getTemplateManager().getTemplateByID("hubs");
            if (hubTemplate == null)
